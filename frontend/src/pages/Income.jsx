...
const DEFAULT_CATEGORIES = ['Job','Tax Refund','Investments','Gift','Other','Bonus']
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md">
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
              <h2 className="text-lg font-bold text-gray-900">New Income</h2>
        ...
        <table className="w-full">
          ...
          <tbody className="divide-y divide-gray-50">
            {loading ? (
              ...
              <tr><td colSpan={6} className="text-center py-12 text-gray-400">No income found.</td></tr>
            ) : filtered.map(row => (
