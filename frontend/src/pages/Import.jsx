...
function PreviewTable({ title, rows, type }) {
  ...
  return (
    <div className="space-y-2">
      <h3 className="font-semibold text-gray-900">{title} <span className="text-gray-400 font-normal text-sm">({rows.length} rows)</span></h3>
      ...
      <div className="card space-y-4">
        <div className="space-y-2">
          ...
          <p className="text-sm text-gray-500">
            Supports <code className="bg-gray-100 px-1 rounded">.xlsx</code> and <code className="bg-gray-100 px-1 rounded">.xlsm</code> files
            with <strong>Expenses</strong> and/or <strong>Income</strong> sheets.
          </p>
